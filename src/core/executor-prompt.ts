 ...
 */
export function renderQualityProfileGuardrailLines(node: GoalDagNode): string[] {
 ...
 */
export function renderExecutorGuardrailLines(node: GoalDagNode): string[] {
...
export function renderExecutorGuardrails(node: GoalDagNode): string {
  return renderExecutorGuardrailLines(node).join("\n");
}

export function promptIncludesExecutorGuardrails(prompt: string | undefined): boolean {
 ...
 */
export function promptIncludesQualityProfile(prompt: string | undefined): boolean {
